...
export function TestimonialCard({
  ...
  return (
    <motion.div
      ...
      className={`h-full min-w-[min(100%,320px)] max-w-[360px] flex-shrink-0 snap-center ${className ?? ""}`}
    >
      <GlassCard hover className="relative flex h-full flex-col p-6 md:p-8">
